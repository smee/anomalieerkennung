(ns ^{:doc "A purely functional implementation of the levenshtein distance in clojure. Origin: https://gist.github.com/vishnuvyas/958488"}
    scada-ui.util.levensthein)
